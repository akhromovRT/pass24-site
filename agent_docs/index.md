...
## Ключевые документы (v2.0)
- `agent_docs/blueprint.md` — **маркетинговый blueprint**: позиционирование, контент всех страниц, CTA, копирайтинг, SEO, дорожная карта. Читать при работе над контентом, текстами, структурой страниц.
- `agent_docs/technical-spec.md` — **техническое ТЗ**: стек WordPress, плагины, интеграция Битрикс24, аналитика, скоринг лидов, автопубликация, nurture-цепочки. Читать при разработке и настройке.
...
- `agent_docs/adr.md` — 11 архитектурных решений: техстек (ADR-001–005), стратегия контента и конверсии (ADR-006–011).
...
- `agent_docs/integrations.md` — автоматизация продаж: поток лидов WordPress → Битрикс24, модель скоринга, n8n автопубликация, Битрикс24 Open Lines чат-бот, nurture email-цепочка, многошаговая форма.
